...
module.exports = function (app) {
	app.get('/api/error/:idx', function(req, res, next) {
	...
	app.get('/api/error/:idx/callstack', function(req, res, next) {
	...
	app.get('/api/error/:idx/daily', function(req, res, next) {
		var error_id = req.params.idx;
		var period = 6;
	...
	app.get('/api/error/:idx/instances', function(req, res, next) {
		var error_id = req.params.idx;
		var period = 6;
	...
	app.get('/api/error/:idx/statistics', function(req, res, next) {
		var error_id = req.params.idx;
		var period = 6;
		connectionPool.getConnection(function(err, connection) {
			async.waterfall([
	...
	app.get('/api/error/:idx/eventpath', function(req, res, next) {
