...
router.get('/project/:project_id/osversion', function(req, res) {
...
// 통계 페이지 country
router.get('/project/:project_id/country', function(req, res) {
    res.header('Access-Control-Allow-Origin', '*');
    if(req.user) {
        var project_id = req.params.project_id;
        var period = 6;
...
// 통계 페이지 device (상위 9개)
router.get('/project/:project_id/device', function(req, res) {
    res.header('Access-Control-Allow-Origin', '*');
    if(req.user) {
        var project_id = req.params.project_id;
        var period = 6;
...
router.get('/project/:project_id/errorclassname', function(req, res) {
    res.header('Access-Control-Allow-Origin', '*');
    if(req.user) {
        var project_id = req.params.project_id;
        var period = 6;
...
// 통계 페이지 lastactivity
router.get('/project/:project_id/lastactivity', function(req, res) {
    res.header('Access-Control-Allow-Origin', '*');
    if(req.user) {
        var project_id = req.params.project_id;
        var period = 6;
...
router.get('/project/:project_id/error_version', function(req, res) {
    res.header('Access-Control-Allow-Origin', '*');
    if(req.user) {
        var project_id = req.params.project_id;
        var period = 6;
